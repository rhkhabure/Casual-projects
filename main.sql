...
INSERT INTO Department VALUES(778, 'Teenagers', 'Kiambu', '0145835475', 4864);
...
insert into Company_Car values(612, 'KCB223k', 'BMW', 'X6', '06-Apr-1994', 222);
insert into Company_Car values(611, 'KBX123Z', 'Mercedes', 'Benz', '06-Apr-2001', 111);
insert into Company_Car values(613, 'KAT323L', 'Toyota', 'Sprinter', '05-Nov-2003', 333);
INSERT INTO Company_Car VALUES(99, 'KCC 234D', 'Bentley', 'ES8', '08-Dec-2012', 100);
INSERT INTO Company_Car VALUES(98, 'KCD 342K', 'Auburn', 'EC7', '04-Sep-2008', 101);
INSERT INTO Company_Car VALUES(97, 'KDD 245Z', 'AuDI', 'ES6', '06-Jul-2014', 102);
INSERT INTO Company_Car VALUES(96, 'KDA 124B', 'Cadillac', 'ER3', '31-Aug-2004', 111);
INSERT INTO Company_Car VALUES(95, 'KCB 353R', 'Ford', 'EZ1', '10-Jan-2010', 132);
INSERT INTO Company_Car VALUES(94, 'KDA 234C', 'Hyundai', 'ER5', '20-Sep-2017', 112);
INSERT INTO Company_Car VALUES(93, 'KDD 438K', 'Jensen', 'E0D', '03-Apr-2009', 108);
INSERT INTO Company_Car VALUES(92, 'KCM 248C', 'Lincoln', 'EB2', '18-Aug-2016', 109);
INSERT INTO Company_Car VALUES(91, 'KDK 242B', 'Morgan', 'EBK', '11-Feb-2011', 107);
INSERT INTO Company_Car VALUES(90, 'KDM 323D', 'Peugeot', 'EB7', '22-Dec-2007', 105);
...
--cleaned
insert into Product values(511, 'Gum that comes in three flavours of strawberry, peach and apple', '5-Apr-2015', 15.00, 777);
insert into Product values(522, 'Lollipops are sweets placed on a plastic stick that is licked and flavors the saliva', '12-Jan-2009', 10.00, 666);
insert into Product values(533, 'Jelly is soft and slightly viscous fluid that is flavored and comes in a small container', '14-Mar-2001', 20.00, 555);
INSERT INTO Product VALUES(510, 'Strawberry flavored', '1-Feb-2010', 10.00, 1);
INSERT INTO Product VALUES(513, 'Raspberry flavored', '3-Mar-2024', 10.00, 1);
INSERT INTO Product VALUES(512, 'Contains nuts and gluten', '2-Feb-2024', 10.00, 1);
INSERT INTO Product VALUES(515, 'Made in Cacao plant', '4-Apr-2014', 50.00, 2);
INSERT INTO Product VALUES(514, 'Contains fructose', '9-Nov-2023', 80.00, 3);
...
insert into Product_Warehouse values(511, 533, 322);


create synonym Storage for Warehouse;
create synonym Worker for Employee;
--cleaned 
CREATE TRIGGER trg_dependent_assignment
...
BEGIN
    ...
    IF employee_id IS NULL THEN
        -- RAISE_APPLICATION_ERROR is not supported in SQLite. You can use RAISE() function with custom error message.
        RAISE(ABORT, 'Dependent must be associated with an employee.');
    END IF;
END;
...
SELECT 
    ...
    d.phone_number AS department_phone_number
FROM 
    Employee 
JOIN 
